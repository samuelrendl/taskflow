...
async function main() {
  ...
  const dummyUsers = [
    ...
    },
    {
      ...
      role: Role.DEVELOPER,
      image: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80'
    },
    {
      name: 'Eve Martinez',
